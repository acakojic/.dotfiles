...
;;aca dodao
;; (xah-fly--define-keys
;;  (define-prefix-command 'xah-fly-android-studio-keymap)
;;  '(
;;    ("t" . flymake-goto-next-error)
;;    ("i" . lsp-ui-peek-find-definitions)
;;    ;; ("n" . lsp-ui-peek-find-implementation)
...
(progn
  ...
  (progn
    ...
    (define-key xah-fly-key-map (kbd "<pause>") 'change-color-and-got-to-line-mode) ; aca dodao
...
Version 2017-01-21"
  ...
  (xah-fly--define-keys
   ...
   '(
     ...
     ("SPC" . xah-fly-leader-key-map) ;;aca vratiti?
     ...
     ("(" . xah-backward-left-bracket) ;;aca menjao m u w
     ("v" . scroll-up-command) ;aca
     ("w" . scroll-down-command) ;aca
     ("n" . forward-char)
     ("o" . open-line)
     ("p" . xah-kill-word)
...
(defun xah-fly-insert-mode-init ()
  ...
  (xah-fly--define-keys
   ...
   '(
     ...
     ("(" . nil) ;;aca dodao ako ovo ne uradim, koristim u line i char modu
     (")" . nil) ;;aca dodao ako ovo ne uradim, koristim u line i char modu
...
Version 2017-07-07"
  ...
  (progn 
    ...
    (message "xah-fly-keys.el - 4161 - xah-fly-command-mode-activate")
...
Version 2017-07-07"
  ...
  (progn
    (xah-fly-command-mode-init)
    (message "xah-fly-keys.el - 4169 - xah-fly-command-mode-activate-no-hook")
    (xah-fly--define-keys
		     (define-prefix-command 'xah-fly-leader-key-map)
		     '(
		       ("x" . switch-to-buffer)
...
;; (setq xah-fly-keys-are t) ;;aca dodao
...
(defun xah-fly-keys-off ()
  ...
  (progn
    ...
    (remove-hook 'minibuffer-exit-hook 'xah-fly-command-mode-activate) ;;aca
